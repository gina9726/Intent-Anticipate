...
class RNN():
    ...
    def build_model(self):
        ...
        #selected_mask = tf.ones([self.batch_size, 1]) # 1 :combine feature, 0 :sensor feature
        ...
        #probs_vec = tf.gather(tf.reshape(probs_vec, [-1]), tf.where(actions_mask == 1))
    ...
    def act(self, _observations):
        #assert _observations.get_shape().as_list()[0] == 40
        #assert _observations.get_shape().as_list()[1] == 1024 
